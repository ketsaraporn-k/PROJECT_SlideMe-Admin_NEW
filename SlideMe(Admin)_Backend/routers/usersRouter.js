 ...
 *     description: |
 *                  - ใช้ชื่อผู้ใช้และรหัสผ่านเข้าสู่ระบบ
 *                  - ระบบจะตรวจสอบข้อมูลและคืนค่า JWT token เพื่อใช้ยืนยันตัวตน🔑
 *     tags:
 *       - userslogin
 *     requestBody:
 *       required: true
 ...
 *     description: |
 *                  - ใช้ JWT token เพื่อยืนยันตัวตนของผู้ใช้ 🔍
 *                  - ระบบจะตรวจสอบข้อมูลและคืนค่า role ของผู้ใช้
 *                  - ใช้สำหรับแอปที่ต้องการให้ผู้ใช้ล็อกอินก่อนเข้าถึงข้อมูล
 *                  - ถ้าผู้ใช้ไม่มีบทบาทใดๆ จะคืนค่า 404
 *                  - ถ้าผู้ใช้มีบทบาทใดๆ จะคืนค่า 200
 *     tags:
 *       - userslogin
 *     security:
 *       - bearerAuth: []
 ...
 *                  - ใช้ JWT token เพื่อตรวจสอบสิทธิ์
 *                  - ผู้ใช้ที่มีบทบาท worker จะไม่สามารถเรียก API นี้ได้
 *     tags:
 *       - userslogin
 *     security:
 *       - bearerAuth: []
